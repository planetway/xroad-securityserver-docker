...
PlanetCross Security server Docker container requires an external PostgreSQL database.
...
```
docker run -it --rm -e PX_INI_MESSAGELOG_A=128 -e PX_CONF_PROXY_PARAMS=' -Xms1000m' planetway/xroad-securityserver cat /etc/xroad/services/local.conf /etc/xroad/conf.d/local.ini
```
...
* In PlanetCross Community https://planetway.com/planetcross-community/

## License, Terms of Use

By downloading the Docker image, you represent that you have read, understood and agreed to be bound by the [PlanetCross License Agreement](https://planetway.com/legal/PX_License_Agreement.pdf).
